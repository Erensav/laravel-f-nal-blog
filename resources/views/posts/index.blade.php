    ...
    <div class="mx-auto max-w-8xl px-6 my-16 lg:px-8">
        @if (empty($posts))
            <div class="mx-auto max-w-2xl text-center">
                <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Henüz gönderi yok</p>
                <a href="{{ route('posts.new') }}"><x-primary-button class="mt-8">Yeni bir gönderi oluştur</x-primary-button></a>
            </div>
        @else
            <div class="mx-auto max-w-2xl text-center">
